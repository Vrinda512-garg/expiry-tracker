    ...
    <div className="flex min-h-screen text-white">
      ...
      <div className="flex w-1/2 items-center justify-center px-12 bg-[#0a0a0a]">
        <div className="w-full max-w-md rounded-3xl border border-yellow-400/20 bg-white/10 p-10 backdrop-blur-xl shadow-[0_0_40px_rgba(250,193,0,0.25)]">
          <Link to="/personal/login" className="text-sm text-yellow-400 hover:text-yellow-300 transition">
            ← Back to Login
          </Link>

          <h1 className="mt-8 text-4xl font-bold text-yellow-400">Create Account</h1>
          ...
          <p className="mt-8 text-center text-gray-400">
            ...
            <Link to="/personal/login" className="text-yellow-400 hover:text-yellow-300 font-medium">
              Login
            </Link>
          </p>
        </div>
