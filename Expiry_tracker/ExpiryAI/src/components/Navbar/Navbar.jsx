  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full backdrop-blur-md">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-10 md:px-16">
        ...
        <nav className=" flex items-center justify-center text-center gap-8 md:flex">
          <a
            href="#home"
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="rounded-full border-2 border-yellow-400 px-6 py-2 text-sm  font-semibold text-yellow-400 transition-all duration-300 hover:bg-yellow-400 hover:text-black">
           Explore
          </button>
          ...
          <div className="bg-theme(color-primary) text-black p-6">
  Theme Test
</div>
